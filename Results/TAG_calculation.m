% TAG calculation 
% The plot is currently coded for scenarios where TSOs in DK, DE or NL has 
% responsibility, and requires minor changes when other TSOs are involved. 
%% Loading data
...
CR_TSO = zeros(1,9);
CR_TSO(2) = CR_DC(4); 
% CR_TSO(2) = CR_AC(5)*0.5;
CR_TSO(3) = CR_DC(6);
CR_TSO(5) = CR_DC(7);
%CR_TSO(5) = CR_AC(2)*0.5;
%CR_TSO(1) = CR_AC(2)*0.5;
